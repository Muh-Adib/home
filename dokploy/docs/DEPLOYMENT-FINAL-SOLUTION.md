...
mv nixpacks-working.toml nixpacks.toml
```
...
### **Pre-Deployment:**
- ✅ Gunakan konfigurasi minimal tanpa PHP extensions
...
**🎯 FOKUS UTAMA**: 
- ✅ Hapus semua PHP extensions yang bermasalah
- ✅ Gunakan konfigurasi minimal dengan core dependencies
