...
main() {
    ...
    log_info "   🖥️  Main App (Internal): Port 8080"
...
start_supervisor() {
    ...
    log_info "   - Main App: Internal only (no external port)"
    log_info "   - Nginx: -p 15000:80"
    log_info "   - WebSocket: Internal only (no external port)"
    log_info ""
    log_info "📋 Dokploy Configuration:"
    log_info "   - Set Port Mapping: 15000:80"
    log_info "   - Domain: app.homsjogja.com → Port 15000"
    log_info ""
