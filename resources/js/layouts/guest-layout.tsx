                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <ul className="space-y-3">
                                        <li>
                                            <Link href="/about" className="text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                                                {t('nav.about')}
                                            </Link>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <Link href="/support" className="text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                                                {t('nav.support')}
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="/faq" className="text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                                                {t('nav.faq')}
                                            </Link>
                                        </li>
                                    </ul>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <ul className="space-y-3">
                                        <li>
                                            <Link href="/privacy" className="text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                                                {t('nav.privacy')}
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="/tos" className="text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                                                {t('nav.tos')}
                                            </Link>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <Link href="/disclaimer" className="text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                                                {t('nav.disclaimer')}
                                            </Link>
                                        </li>
                                    </ul>
