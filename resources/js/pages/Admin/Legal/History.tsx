            ...
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Riwayat Versi</h1>
                        ...
                        <div className="flex items-start justify-between">
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                    <CardTitle className="text-xl">Versi Saat Ini</CardTitle>
                                ...
                                <CardDescription className="flex items-center gap-2">
                                    ...
                                    Dipublikasikan: {formatDate(active.published_at)}
                                </CardDescription>
                            </div>
                ...
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-semibold text-gray-900">
                            Versi yang Diarsipkan ({archived.total})
                        </h2>
                    </div>
                    ...
                    {archived.data.length === 0 ? (
                        <Card>
                            <CardContent className="py-12 text-center">
                                ...
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">Tidak Ada Versi yang Diarsipkan</h3>
                                <p className="text-gray-500">Ini adalah versi pertama dari dokumen ini.</p>
                            </CardContent>
                        </Card>
                    ) : (
                    ...
                    {archived.last_page > 1 && (
                        <div className="flex items-center justify-between mt-6">
                            <div className="text-sm text-gray-600">
                                Menampilkan {archived.from} - {archived.to} dari {archived.total} versi
                            </div>
                            <div className="flex gap-2">
                                ...
                                <span className="flex items-center px-4 text-sm text-gray-600">
                                    Halaman {archived.current_page} dari {archived.last_page}
                                </span>
